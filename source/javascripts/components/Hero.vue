      ...
      <div class="container">
        <div class="columns is-vcentered">
          <div class="column is-6">
            <h1
              class="title is-spaced is-size-1"
            >Jump-start your next project with a static site template</h1>
            <h2
              class="subtitle"
            >Unchanging is a static site template using Middleman, webpack, and Vue.js, and Bulma. I use this as a starting point for my static sites. Feel free to fork or clone the repo for your next project.</h2>
            <button class="button is-large has-text-weight-bold">Get Started</button>
          </div>
          <div class="column is-5 is-offset-1 is-hidden-mobile">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 942.98 904.96">
              <defs />
              ...
              <g id="Layer_2" data-name="Layer 2">
                <g id="Layer_2-2" data-name="Layer 2">
                  ...
                  />
                  <path class="cls-2" d="M95.5,532.46c-7-2-28-15-32-20S50,519.59,67.25,536" />
                  <path class="cls-3" d="M87.5,524.46c-7-2-28-15-32-20S42,511.59,59.25,528" />
                  <path class="cls-2" d="M175.5,563.46c-5-6-22-31-25-39s-23.43-16-10.22,39" />
                  <path
                    class="cls-3"
                  ...
                  />
                  <path class="cls-3" d="M347.86,623.4c16-51.75,38.73-101.52,70.9-137.81" />
                  <path class="cls-3" d="M316.61,778.62c2.58-22.47,6.19-47.6,11.21-73.81" />
                  <path
                    class="cls-4"
                  ...
                  />
                  <path class="cls-3" d="M602.12,615c-11.88-53.55-12.5-113.55,27.14-140.26" />
                  <polyline
                    class="cls-3"
                    points="762.88 156.46 797.5 156.46 797.5 778.46 175.5 778.46 175.5 748.57"
                  />
                  <polyline class="cls-3" points="175.5 204.63 175.5 156.46 629.26 156.46" />
                  <line class="cls-3" x1="175.5" y1="574.6" x2="175.5" y2="356.76" />
                  <path
                    class="cls-2"
                  ...
                  />
                  <ellipse class="cls-2" cx="517" cy="274.46" rx="103.5" ry="132" />
                  <path
                    class="cls-3"
                  ...
                  />
                  <path class="cls-3" d="M466.5,252.46c-1,10-14,38-24,48" />
                  <path class="cls-3" d="M473.5,340.46c5,0,15-2,23-14" />
                  <ellipse
                    class="cls-6"
                    cx="437.25"
                    cy="260.21"
                  ...
                  />
                  <circle class="cls-2" cx="596.5" cy="292.46" r="27" />
                  <path class="cls-3" d="M561.5,284.46a27,27,0,0,1,18.87-25.76" />
                  <path
                    class="cls-3"
